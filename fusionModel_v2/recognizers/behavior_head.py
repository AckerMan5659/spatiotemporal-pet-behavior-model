...
class LSTMHead(nn.Module):
    def __init__(self, feat_dim: int, num_classes: int, hidden: int = 256, layers: int = 2):
        super().__init__()
...
class TransformerHead(nn.Module):
    def __init__(self, feat_dim: int, num_classes: int, num_heads: int = 4, depth: int = 2):
        super().__init__()
...
class MambaHead(nn.Module):
    def __init__(self, feat_dim: int, num_classes: int, d_state: int = 16, d_conv: int = 4, expand: int = 2):
        super().__init__()
...
class TSMConsensusHead(nn.Module):
    ...
    2. 线性分类。
    """
    def __init__(self, feat_dim: int, num_classes: int, dropout: float = 0.0):
        super().__init__()
